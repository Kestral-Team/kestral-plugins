...
1. **Authenticate** — opens a browser tab at `app.kestral.ai/cli-auth`. Approve in your browser. The plugin picks up
   your API key automatically and saves it to `~/.kestral/credentials`.
